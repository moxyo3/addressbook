        ...
        <div class="modal-window">
            ...
            <form action="{{ url('/addAddress') }}" method="post" id="address-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kana_family" id="kana_family" required>
                </div>

                <div class="form-group">
                    <label for="kana_name">名（ふりがな）*</label>
                    <input type="text" name="kana_name" id="kana_name" required>
                </div>

                <div class="form-group">
                    <label for="post_num">郵便番号*</label>
                    <input type="number" name="post_num" id="post_num" required>
                    ※7桁の数字で入力してください
                </div>
            ...
            <form id="address-form" action="{{ url('/update') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="post_num">郵便番号*</label>
                    <input type="number" name="post_num" id="post_num" value="{{ $item->post_num }}" required>
                    ※7桁の数字で入力してください
                </div>
